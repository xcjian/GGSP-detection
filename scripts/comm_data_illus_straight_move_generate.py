...
Run this file to generate the data for the communication scenario with straight moving transmitters.
"""
...
parser.add_argument('--T_range', type=int, nargs='+', default=[20],
                    help='The number of instances.')
parser.add_argument('--step_size_min', type=float, default=2,
...
for T_idx, T in enumerate(T_range):
    ...
    dat_dir = os.path.join(dat_dir, 'straight_move_illus_data', f'T_{T_idx}')
    res_dir = os.path.join(res_dir, 'straight_move_illus_res', f'T_{T_idx}')
